/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b8927ccb075cd5714cf55b300b65767a)
...
interface __BaseEnv_Env {
	...
	LOCAL_STATION: "";
	MONITOR_URLS: "[{\"name\":\"Claude\",\"url\":\"https://status.anthropic.com/api/v2/status.json\",\"type\":\"statuspage\"},{\"name\":\"GitHub\",\"url\":\"https://www.githubstatus.com/api/v2/status.json\",\"type\":\"statuspage\"}]";
	GOOGLE_CLIENT_ID: string;
	GOOGLE_CLIENT_SECRET: string;
	GOOGLE_REFRESH_TOKEN: string;
	CAMERA_RELAY: DurableObjectNamespace /* CameraRelay */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/index");
		durableNamespaces: "CameraRelay";
	}
